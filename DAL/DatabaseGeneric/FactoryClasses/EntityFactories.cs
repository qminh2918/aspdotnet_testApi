...
namespace test.Dal.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, test.Dal.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((test.Dal.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public TestEntityFactory() : base("TestEntity", test.Dal.EntityType.TestEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new TestEntity(fields); }
	}
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(test.Dal.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(test.Dal.EntityType)))
			{
				var factory = GetFactory((test.Dal.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the test.Dal.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(test.Dal.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case test.Dal.EntityType.TestEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the test.Dal.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (test.Dal.EntityType)Enum.Parse(typeof(test.Dal.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((test.Dal.EntityType)Enum.Parse(typeof(test.Dal.EntityType), leftOperandEntityName, false), joinType, (test.Dal.EntityType)Enum.Parse(typeof(test.Dal.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (test.Dal.EntityType)Enum.Parse(typeof(test.Dal.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((test.Dal.EntityType)entityTypeValue); }
