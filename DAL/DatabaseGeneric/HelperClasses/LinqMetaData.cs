...
namespace test.Dal.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((test.Dal.EntityType)typeOfEntity)
			{
		...
		public DataSource2<TestEntity> Test {	get { return new DataSource2<TestEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
